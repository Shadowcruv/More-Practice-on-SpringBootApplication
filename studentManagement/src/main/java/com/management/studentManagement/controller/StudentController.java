...
public class StudentController {
  ...
  //  @Transactional
    @PostMapping("/saveParticular/{id}")
    public String saveParticularStudent(@PathVariable Long id, @ModelAttribute("studentp") Student student){

        Student originalStudent = studentService.getStudent(id);
